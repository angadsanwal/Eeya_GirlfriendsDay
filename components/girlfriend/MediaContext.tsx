...
const DEFAULT_TEXTS: TextContent = {
  ...
  coupons: [
    ...
    { id: 'BDAY-012', emoji: '🌹', title: 'Flowers Just Because', note: 'No occasion required.' },
    { id: 'BDAY-013', emoji: '😴', title: 'One Lazy Day Together', note: 'No plans. No productivity. Just us.' },
    { id: 'BDAY-014', emoji: '👑', title: 'You Pick Dinner, I Pay', note: 'Budget negotiations are prohibited.' },
